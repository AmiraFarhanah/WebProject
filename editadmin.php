    ...
    <div class="kotak form-kotak">
        ...
        <?php
            if(isset($_POST['submit'])){
                ...
                $edit_query=mysqli_query($con, "UPDATE administrator SET Administrator_Name='$name', Administrator_Username='$username', Administrator_Password='$password', Administrator_Address= '$address', Administrator_PhoneNum='$phonenumber', Administrator_EmailAddress='$email' WHERE ID=$id") or die("error occurred");
                if($edit_query){
