        ...
        <?php
            ...
            if(isset($_POST['submit'])){
                ...
                if(mysqli_num_rows($verify_query)!=0){
                    ...
                    mysqli_query($con, "INSERT INTO registered_user (Name, Password, Address, Phonenumber, Username, Usergroup) VALUES ('$name', '$password', '$address', '$phonenumber', '$username', '$usergroup')") or die("Error Occured");
                    echo "<div class='message'>
