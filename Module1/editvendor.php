    ...
    <div class="kotak form-kotak">
        ...
        <?php
            if(isset($_POST['submit'])){
                ...
                $edit_query=mysqli_query($con, "UPDATE food_vendor SET Name='$name', Username='$username', Password='$password', Address= '$address', Phonenumner='$phonenumber', Email='$email', Qrcode='$qrcode' WHERE ID=$id") or die("error occurred");
                if($edit_query){
