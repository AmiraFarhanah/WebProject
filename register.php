        ...
        <?php
            ...
            if(isset($_POST['submit'])){
                ...
                if(mysqli_num_rows($verify_query)!=0){
                    ...
                    $verify_query=mysqli_query($con, "SELECT Vendor_Username FROM food_vendor WHERE Vendor_Username= '$username' ");
                ...
                if(mysqli_num_rows($verify_query)!=0){
                    ...
                    mysqli_query($con, "INSERT INTO food_vendor (Vendor_Name, Vendor_Password, Vendor_Address, Vendor_PhoneNum, Vendor_Username, Usergroup, Vendor_Email) VALUES ('$name', '$password', '$address', '$phonenumber', '$username', '$usergroup', '$email')") or die("Error Occured");
                    echo "<div class='message'>
                        <p>Registeration successfully!</p>
                        </div><br>";
                    echo "<a href='login.php'><button class='btn'>Login Now</button>";
